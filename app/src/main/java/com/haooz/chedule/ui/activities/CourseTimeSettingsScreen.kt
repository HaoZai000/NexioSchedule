...
@Composable
fun CourseTimeSettingsScreen(onBack: () -> Unit, liquidGlassBackdrop: com.kyant.backdrop.Backdrop? = null) {
        ...
        Scaffold(
            ...
            OverlayDialog(
                title = when (editingPeriod) {
                    ...
                    "afternoon" -> "第${morningSections.value + editingSection}节时间设置"
                    "evening" -> "第${morningSections.value + afternoonSections.value + editingSection}节时间设置"
                    else -> "时间设置"
                },
                show = showTimeDialog,
